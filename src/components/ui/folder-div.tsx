...
export default function FolderDiv({ children, className = "" }: FolderDivProps) {
    return (
        <div className="relative bg-[#837156] bg-[url(/assets/folder.jpg)] bg-blend-overlay bg-size-[30%] p-2 sm:p-6 lg:p-6 shadow-2xl/90 rounded-lg w-full">
            <div className="relative group h-full">
                <div
                    className={`relative flex flex-col z-10 w-full p-5 h-full shadow-lg bg-[linear-gradient(rgba(249,249,249,0.5),rgba(249,249,249,0.5)),url(/assets/paper.png)] bg-repeat bg-size-[30%] border border-gray-300 ${className}`}
                >
                    {children}
                </div>
