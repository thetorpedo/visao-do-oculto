...
export default function FolderDiv({ children, className = "" }: FolderDivProps) {
    return (
        <div onClick={(e) => e.stopPropagation()} className={`relative bg-[#837156] bg-[url(/assets/folder.jpg)] bg-blend-overlay bg-size-[30%] p-2 sm:p-6 lg:p-6 shadow-2xl/90 rounded-lg w-full ${className}`}>
